    ...
    tools: [
      {
        ...
        description: "Generate truly random integers or decimals with given ranges and count.",
        path: "/tools/random-number",
        category: "Generators",
        icon: Dices,
        seoTitle: "Online Random Number Generator - Free & Custom Ranges",
        seoDescription: "Generate random numbers, integers, and decimals online. Guarantee unique values, customize ranges, and handle bulk number generation in your browser.",
        keywords: ["random number generator", "rng online", "random integer", "bulk random numbers"],
        techName: "Math.random()",
        techUrl: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Math/random"
      },
      {
        id: "uuid",
        name: "UUID Generator",
